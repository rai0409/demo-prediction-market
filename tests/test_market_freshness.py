...
@pytest.mark.parametrize(
    ...
    [
        (None, "unavailable"),
        (NOW, "current"),
        (NOW - timedelta(minutes=6, seconds=59, microseconds=999999), "current"),
        (NOW - timedelta(minutes=7), "delayed"),
        (NOW - timedelta(minutes=14, seconds=59, microseconds=999999), "delayed"),
        (NOW - timedelta(minutes=15), "stale"),

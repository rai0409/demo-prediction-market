...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "market.catalog_title": "全マーケット",
        "market.catalog_subtitle": "条件を指定して市場を探し、比較できます。",
        "market.search": "検索",
        "market.search_placeholder": "タイトル・質問・識別名で検索",
        "market.filter_active": "表示中",
        "market.filter_closed": "終了済み",
        "market.filter_all": "すべて",
        "market.sort_label": "並び替え",
        "market.sort_volume_24h": "24時間出来高",
        "market.sort_liquidity": "流動性",
        "market.sort_end_date": "終了日時",
        "market.sort_probability": "確率",
        "market.sort_updated": "最終更新",
        "market.order_asc": "昇順",
        "market.order_desc": "降順",
        "market.clear_filters": "条件をクリア",
        "market.no_results": "条件に一致するマーケットはありません。",
        "market.total_results": "件のマーケット",
        "market.page_size": "表示件数",
        "market.detail": "詳細を見る",
        "market.demo_eligible": "デモ参加可",
        "market.not_eligible": "デモ参加対象外",
        ...
        "realtime.best_bid": "参考下限レンジ",
        "realtime.best_ask": "参考上限レンジ",
    ...
    "en": {
        ...
        "market.catalog_title": "All markets",
        "market.catalog_subtitle": "Search, filter, and compare markets.",
        "market.search": "Search",
        "market.search_placeholder": "Search title, question, or slug",
        "market.filter_active": "Active",
        "market.filter_closed": "Closed",
        "market.filter_all": "All",
        "market.sort_label": "Sort",
        "market.sort_volume_24h": "24h volume",
        "market.sort_liquidity": "Liquidity",
        "market.sort_end_date": "End date",
        "market.sort_probability": "Probability",
        "market.sort_updated": "Updated",
        "market.order_asc": "Ascending",
        "market.order_desc": "Descending",
        "market.clear_filters": "Clear filters",
        "market.no_results": "No markets match these filters.",
        "market.total_results": "markets",
        "market.page_size": "Per page",
        "market.detail": "View details",
        "market.demo_eligible": "Demo eligible",
        "market.not_eligible": "Not eligible",
        ...
        "realtime.best_bid": "Reference lower range",
        "realtime.best_ask": "Reference upper range",

...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "wallet.note_non_cashable": "デモポイントはMVP検証用の非換金スコアです。換金、譲渡、商品・ギフト券・Pay・株引換券・暗号資産との交換はできません。",
    ...
    "en": {
        ...
        "wallet.note_non_cashable": "Demo points are non-cash MVP validation scores. They cannot be cashed out, transferred, or exchanged for products, gift cards, Pay balances, stock vouchers, crypto assets, or anything outside the app.",
